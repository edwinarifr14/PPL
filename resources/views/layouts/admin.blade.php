...
<body id="page-top" class="{{ requesturl() === url('/admin/login') ? 'bg-dark' : '' }}">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
        ...
        <a class="navbar-brand mr-1" href="{{ url('/admin') }}">Admin Taniku</a>
        ...
        <ul class="sidebar navbar-nav">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="pelanggan-dropdown">
                    <a class="dropdown-item" href="{{ url('/admin/datapelanggan') }}">Data Pelanggan</a>
                    <a class="dropdown-item" href="{{ url('/admin/datatopup') }}">Data Top Up</a>
                </div>
            ...
            <footer class="sticky-footer">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright © Taniku 2019</span>
                    </div>
                </div>
            </footer>
